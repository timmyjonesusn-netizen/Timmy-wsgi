...
<style>
    ...
    * {
    ...
    body {
        min-height:100vh;
        background: radial-gradient(circle at 20% 20%, rgba(255,0,204,0.18) 0%, rgba(0,0,0,0) 60%),
    ...
    .bubble {
        position:absolute;
        border-radius:50%;
        background: radial-gradient(circle at 30% 30%, rgba(255,255,255,0.9) 0%, rgba(255,0,204,0.2) 40%, rgba(0,0,0,0) 70%);
    ...
    .brand {
        ...
        font-weight:600;
        color: var(--text-main);
        text-shadow: 0 0 8px rgba(255,0,204,0.7), 0 0 20px rgba(255,140,0,0.4);
    ...
    .now-serving-label {
        ...
        font-weight:500;
        color: var(--text-glow);
        text-shadow: 0 0 6px rgba(255,0,204,0.8),
